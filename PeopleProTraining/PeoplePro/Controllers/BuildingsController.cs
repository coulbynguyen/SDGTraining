...
namespace PeoplePro.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BuildingName,BuildingAbrev")] Building building)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BuildingName,BuildingAbrev")] Building building)
        {
            if (id != building.Id)
            {
                return NotFound();
